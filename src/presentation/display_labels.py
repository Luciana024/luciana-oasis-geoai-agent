...
GLOSSARY_ROWS = [
    ...
    ("Equity priority", "Prefer income-deprived and currently underserved zones (SIMD income rate and public-transport time to a GP)."),
    ...
    ("Baseline", "This zone's predicted rate if its six SIMD indicators and location are set to Edinburgh medians. Neighbours stay observed. Not a city-average infection rate."),
    ("Income deprivation", "SIMD share of people who are income-deprived. Explains the forecast; not used as a siting score."),
    ("Employment deprivation", "SIMD employment-deprivation indicator for the zone."),
    ("Higher education", "SIMD higher-education / university-entry indicator."),
    ("Overcrowding", "SIMD overcrowding indicator."),
    ("Crime", "SIMD selected neighbourhood-crime indicator."),
    ("Public transport time to GP", "SIMD public-transport minutes to a GP. Current access, not our OSM travel matrix."),
